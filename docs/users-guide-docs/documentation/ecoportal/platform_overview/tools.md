...
All information available through the EcoPortal website is also available through the [REST API documentation]({% link docs/users-guide-docs/documentation/ecoportal/developer_guide/api_key.md %}).
